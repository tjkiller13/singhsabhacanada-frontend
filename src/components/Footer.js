...
const Footer = () => {
  ...
  return (
    <div className={`${location.pathname==="/gurmatcenters"||location.pathname==="/login"||location.pathname==="/contact"?"fixed-bottom":""}`}>
      <footer className="text-center text-lg-start bg-light text-muted">
        <section className="d-flex justify-content-center flex-row p-2 footer-section border-bottom">
          ...
          <div>
            <button type="button" id="donate" className="btn btn-outline-light me-4 text-reset" onClick={()=>{window.open("https://www.paypal.com/donate/?token=yrj4RmlVk0_DPzUrNdcfCNFok3AmNFsBoiqOae0M4EO1qoalVt9gmgSyr9V4Va0mb_NTcW9VKQIjVsRl&locale.x=CA", "_blank")}}>Donate Now!</button>
          </div>
        </section>
